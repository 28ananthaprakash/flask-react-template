...
class CommentView(MethodView):
    ...
    def post(self, account_id: str, task_id: str) -> ResponseReturnValue:
        ...
        create_params = CreateCommentParams(task_id=task_id, account_id=account_id, text=text)
    ...
    def patch(self, account_id: str, task_id: str, comment_id: str) -> ResponseReturnValue:
        ...
        params = UpdateCommentParams(
            task_id=task_id, comment_id=comment_id, account_id=account_id, text=text
        )
